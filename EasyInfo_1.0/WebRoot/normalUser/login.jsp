...
<body>
				...
				<c:otherwise>
					<div class="dropdown">
						...
						<div class="dropdown-content">
							<a href="#">修改密码</a> <a href="<%=path%>/normalUser/loginout.jsp">注销</a>
						</div>
					</div>
				</c:otherwise>
			</c:choose>
	...
	<div class="container">
		...
		<form id="loginFrom" action="UserAction_login.action"
			method="post">
			...
			<div class="form-group">
				<label for="subject">密码</label><input class="form-control item"
