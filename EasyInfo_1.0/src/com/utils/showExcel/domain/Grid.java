package com.utils.showExcel.domain;
...
public class Grid {
	...
	/**
	 * 将poi.ss.usermodel.Color 转换成 java.awt.Color <a
	 * href="http://home.cnblogs.com/u/309701/" target="_blank">@param</a> color
	 */
	...
	public void setFont(org.apache.poi.ss.usermodel.Font font) {
		if (font != null) {
			this.font = new java.awt.Font(font.getFontName(), Font.BOLD,
					font.getFontHeight() / 20 + 2);
		}
	}

	private java.awt.Color poiColor2awtColor(
